...
const Card: FC = () => {
  return (
    <div className="mx-auto my-14 flex items-center justify-center px-8">
      <div className="flex flex-col w-full bg-white rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5  hover:bg-stone-200">
        <div
        ...
        <div className="flex flex-col w-full md:flex-row">
          ...
          <div className="p-4 font-normal text-gray-800 md:w-3/4">
            ...
            <p className="leading-normal">
              ...
              champion of the top division of college football. The format fits
              within the academic calendar and preserves the sport’s unique and
